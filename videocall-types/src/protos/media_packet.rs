...
pub struct VideoMetadata {
    ...
    ///  frame, used by the receiver's jitter buffer to detect intrinsically-stale
    ///  frames that arrive on-time but are minutes old at source (#1656). Distinct
    ...
    ///  receivers MUST treat 0 as absent (no capture-age signal). Peer-controlled
    ///  value (inside the E2EE packet): the relay cannot forge it, but the sending
    ///  peer can lie; the receiver clamps/sanity-ranges it and bounds blast radius
    ///  to that peer's own tile (see jitter_buffer capture-age logic).
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x02\x07\x12\x03Z\x02\x1d\x1a\xe2\x05\x20Sender-side\x20capture\x20wall-\
    clock\x20time\x20(ms\x20since\x20UNIX\x20epoch,\x20Date.now())\x20of\x20\
    the\n\x20frame,\x20used\x20by\x20the\x20receiver's\x20jitter\x20buffer\
    \x20to\x20detect\x20intrinsically-stale\n\x20frames\x20that\x20arrive\
    \x20on-time\x20but\x20are\x20minutes\x20old\x20at\x20source\x20(#1656).\
    \x20Distinct\n\x20from\x20`MediaPacket.timestamp`\x20(WebCodecs\x20media\
    -time\x20microseconds\x20on\x20a\n\x20per-track\x20origin),\x20which\x20\
    does\x20NOT\x20carry\x20wall-clock.\x20Optional:\x20proto3\n\x20default-\
    zero\x20(0)\x20means\x20\"unknown\x20/\x20not\x20sent\"\x20\xe2\x80\x94\
    \x20older\x20publishers\x20omit\x20it\x20and\n\x20receivers\x20MUST\x20t\
    reat\x200\x20as\x20absent\x20(no\x20capture-age\x20signal).\x20Peer-cont\
    rolled\n\x20value\x20(inside\x20the\x20E2EE\x20packet):\x20the\x20relay\
    \x20cannot\x20forge\x20it,\x20but\x20the\x20sending\n\x20peer\x20can\x20\
    lie;\x20the\x20receiver\x20clamps/sanity-ranges\x20it\x20and\x20bounds\
    \x20blast\x20radius\n\x20to\x20that\x20peer's\x20own\x20tile\x20(see\x20\
    jitter_buffer\x20capture-age\x20logic).\n\n\x0c\n\x05\x04\x02\x02\x07\
    \x05\x12\x03Z\x02\x08\n\x0c\n\x05\x04\x02\x02\x07\x01\x12\x03Z\t\x18\n\
    \x0c\n\x05\x04\x02\x02\x07\x03\x12\x03Z\x1b\x1c\n\x90\x01\n\x02\x05\0\
    \x12\x04_\0o\x01\x1a\x83\x01\x20Video\x20codec\x20enum\x20with\x20profil\
    e/level\x20details\x20for\x20scalability.\n\x20Format\x20follows\x20WebC\
    odecs\x20codec\x20string\x20conventions\x20where\x20applicable.\n\n\n\n\
    \x03\x05\0\x01\x12\x03_\x05\x0f\n=\n\x04\x05\0\x02\0\x12\x03`\x02\x1e\"0\
    \x20Default\x20-\x20skip\x20decoding\x20if\x20codec\x20not\x20specified\
    \n\n\x0c\n\x05\x05\0\x02\0\x01\x12\x03`\x02\x19\n\x0c\n\x05\x05\0\x02\0\
    \x02\x12\x03`\x1c\x1d\n.\n\x04\x05\0\x02\x01\x12\x03c\x02\n\x1a!\x20VP8\
    \x20-\x20no\x20profile/level\x20variants\n\n\x0c\n\x05\x05\0\x02\x01\x01\
    \x12\x03c\x02\x05\n\x0c\n\x05\x05\0\x02\x01\x02\x12\x03c\x08\t\nu\n\x04\
    \x05\0\x02\x02\x12\x03f\x02\x20\x1a9\x20VP9\x20profiles:\x20vp09.PP.LL.D\
    D\x20(Profile,\x20Level,\x20bit\x20Depth)\n\"-\x20vp09.00.10.08\x20-\x20\
    Profile\x200,\x20Level\x201.0,\x208-bit\n\n\x0c\n\x05\x05\0\x02\x02\x01\
    \x12\x03f\x02\x1b\n\x0c\n\x05\x05\0\x02\x02\x02\x12\x03f\x1e\x1f\n\x89\
    \x02\n\x02\x05\x01\x12\x04u\0y\x01\x1a\xfc\x01\x20Transport\x20over\x20w\
    hich\x20a\x20peer\x20is\x20connected\x20to\x20the\x20SFU.\n\x20Sent\x20p\
    assively\x20as\x20part\x20of\x20HeartbeatMetadata\x20so\x20other\x20peer\
    s\x20can\n\x20surface\x20this\x20in\x20diagnostics.\x20Default\x20value\
    \x200\x20=\x20unknown\x20keeps\x20older\n\x20clients\x20(which\x20never\
    \x20set\x20the\x20field)\x20forward/backward\x20compatible.\n\n\n\n\x03\
    \x05\x01\x01\x12\x03u\x05\x12\n\x0b\n\x04\x05\x01\x02\0\x12\x03v\x02\x18\
    \n\x0c\n\x05\x05\x01\x02\0\x01\x12\x03v\x02\x13\n\x0c\n\x05\x05\x01\x02\
    \0\x02\x12\x03v\x16\x17\n\x0b\n\x04\x05\x01\x02\x01\x12\x03w\x02\x1d\n\
    \x0c\n\x05\x05\x01\x02\x01\x01\x12\x03w\x02\x18\n\x0c\n\x05\x05\x01\x02\
    \x01\x02\x12\x03w\x1b\x1c\n\x0b\n\x04\x05\x01\x02\x02\x12\x03x\x02\x1a\n\
    \x0c\n\x05\x05\x01\x02\x02\x01\x12\x03x\x02\x15\n\x0c\n\x05\x05\x01\x02\
    \x02\x02\x12\x03x\x18\x19\n\x0b\n\x02\x04\x03\x12\x05{\0\x81\x01\x01\n\n\
    \n\x03\x04\x03\x01\x12\x03{\x08\x19\n\x0b\n\x04\x04\x03\x02\0\x12\x03|\
    \x02\x19\n\x0c\n\x05\x04\x03\x02\0\x05\x12\x03|\x02\x06\n\x0c\n\x05\x04\
    \x03\x02\0\x01\x12\x03|\x07\x14\n\x0c\n\x05\x04\x03\x02\0\x03\x12\x03|\
    \x17\x18\n\x0b\n\x04\x04\x03\x02\x01\x12\x03}\x02\x19\n\x0c\n\x05\x04\
    \x03\x02\x01\x05\x12\x03}\x02\x06\n\x0c\n\x05\x04\x03\x02\x01\x01\x12\
    ...
    \x12\x03\x7f\x02\x17\n\x0c\n\x05\x04\x03\x02\x03\x05\x12\x03\x7f\x02\x06\
    \n\x0c\n\x05\x04\x03\x02\x03\x01\x12\x03\x7f\x07\x12\n\x0c\n\x05\x04\x03\
    \x02\x03\x03\x12\x03\x7f\x15\x16\n\x0c\n\x04\x04\x03\x02\x04\x12\x04\x80\
    \x01\x02#\n\r\n\x05\x04\x03\x02\x04\x06\x12\x04\x80\x01\x02\x0f\n\r\n\
    \x05\x04\x03\x02\x04\x01\x12\x04\x80\x01\x10\x1e\n\r\n\x05\x04\x03\x02\
    \x04\x03\x12\x04\x80\x01!\"b\x06proto3\
";
